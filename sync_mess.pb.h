...
inline bool HeaderContentType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, HeaderContentType* value) {
...
inline bool DepositeState_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DepositeState* value) {
...
class Header PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void unsafe_arena_set_allocated_depositefileheader(
      ::filesync::DepositeFileHeader* depositefileheader);
  ::filesync::DepositeFileHeader* unsafe_arena_release_depositefileheader();
...
class DepositeFileHeader PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(DepositeFileHeader* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit DepositeFileHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class SyncPackage PROTOBUF_FINAL :
 ...
 public:
  ...
  void unsafe_arena_set_allocated_header(
      ::filesync::Header* header);
  ::filesync::Header* unsafe_arena_release_header();
...
inline void Header::unsafe_arena_set_allocated_depositefileheader(
    ::filesync::DepositeFileHeader* depositefileheader) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(depositefileheader_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:filesync.Header.depositeFileHeader)
}
...
inline ::filesync::DepositeFileHeader* Header::unsafe_arena_release_depositefileheader() {
...
inline ::filesync::DepositeFileHeader* Header::_internal_mutable_depositefileheader() {
  ...
  if (depositefileheader_ == nullptr) {
    auto* p = CreateMaybeMessage<::filesync::DepositeFileHeader>(GetArena());
...
inline void Header::set_allocated_depositefileheader(::filesync::DepositeFileHeader* depositefileheader) {
  ...
  if (depositefileheader) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(depositefileheader);
...
inline void SyncPackage::unsafe_arena_set_allocated_header(
    ::filesync::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:filesync.SyncPackage.header)
}
...
inline ::filesync::Header* SyncPackage::unsafe_arena_release_header() {
...
inline ::filesync::Header* SyncPackage::_internal_mutable_header() {
  _has_bits_[0] |= 0x00000002u;
  if (header_ == nullptr) {
    auto* p = CreateMaybeMessage<::filesync::Header>(GetArena());
    header_ = p;
  }
  return header_;
}
...
inline void SyncPackage::set_content(const void* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
